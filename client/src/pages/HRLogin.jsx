    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <p style={{ fontSize: '14px', color: '#64748b', margin: 0 }}>Sign in to your HR account</p>
          <span style={{
            display: 'inline-block', marginTop: '12px', padding: '6px 14px',
            background: '#eff4ff', color: '#003fb1', borderRadius: '20px',
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <div>
            <label style={labelStyle} htmlFor="hr-email">Email Address</label>
            <input id="hr-email" type="email" name="email" style={inputStyle} placeholder="hr@company.com" value={formData.email} onChange={handleChange} required />
          </div>
          <div>
            <label style={labelStyle} htmlFor="hr-password">Password</label>
            <input id="hr-password" type="password" name="password" style={inputStyle} placeholder="Enter your password" value={formData.password} onChange={handleChange} required />
          </div>
          ...
          }}>{isSubmitting ? 'Signing in...' : 'Sign In as HR →'}</button>
        </form>

        <div style={{ textAlign: 'center', margin: '20px 0', fontSize: '12px', color: '#94a3b8' }}>or</div>

        <div style={{ textAlign: 'center', fontSize: '13px', color: '#64748b' }}>
          <p style={{ margin: '0 0 8px' }}>Not an HR? <Link to="/login/candidate" style={{ color: '#003fb1', fontWeight: 600, textDecoration: 'none' }}>Login as Candidate</Link></p>
