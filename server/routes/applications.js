...
const { applyToJob, getApplicants, getMyApplications, updateApplicationStatus, getAllApplications, getApplicationById } = require('../controllers/applicationController');
